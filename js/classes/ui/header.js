class Header extends Panel {
  constructor(ui) {
    ...
    this.resroucesTextAdder = scene.add.text(16 + this.resourcesText.width, 36, '', { fontSize: '18px', fill: '#157334', fontFamily: "font1"});
    this.resroucesTextSubber = scene.add.text(16 + this.resourcesText.width, 36, '', { fontSize: '18px', fill: '#73331e', fontFamily: "font1"});
    ...
    this.add(this.resroucesTextAdder);
    this.add(this.resroucesTextSubber);
